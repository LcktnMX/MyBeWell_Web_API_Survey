...
{
    public class WellnessRepository<T> : IRepository<T> where T : class
    {
        private WellnessContext _context { get; set; }

        public WellnessRepository(WellnessContext context)
        {
            _context = context;
        }
